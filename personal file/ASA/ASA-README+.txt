     ...
     ******************************************************************/
     ...
     $Id: ASA-README.ms,v 30.3 2014/01/06 20:29:53 ingber Exp ingber $
     ...
     finance[11,12,13,14,15,16,17], neuroscience[18,19,20,21,22,23,24], and
     combat analyses[25,26,27,28,29,30,31].   Some  papers  illustrate  the
     combined  use of ASA for optimization and sampling[32,33,34,35,36,37].
     ...
     *Multi_Grid, and Multi_Specify become available.  In asa_usr.c, memory
     ...
     to correspond to your choice of parallel algorithm and compiler.
     ...
     *exit_status  can  be  extremely  deceptive,  especially   in   highly
     ...
     [25] L. Ingber, H. Fujio, and M.F. Wehner, "Mathematical comparison of
     ...
     [26] L. Ingber and D.D. Sworder, "Statistical mechanics of combat with
     ...
     [27] L. Ingber, "Statistical mechanics of combat  and  extensions"  in
          [4mToward[24m  [4ma[24m [4mScience[24m [4mof[24m [4mCommand,[24m [4mControl,[24m [4mand[24m [4mCommunications,[24m ed. C.
          Jones,  pp.  117-149,  American  Institute  of  Aeronautics   and
          Astronautics,  Washington,  D.C.  (1993). ISBN 1-56347-068-3. URL
          http://www.ingber.com/combat93_c3sci.pdf.

     [28] M. Bowman and L. Ingber, "Canonical momenta of nonlinear  combat"
     ...
     [29] L.  Ingber,  "Statistical Mechanics of Combat (SMC): Mathematical
     ...
     [30] L. Ingber, "Real Options for Project  Schedules  (ROPS),"  Report
          2007:ROPS,  Lester  Ingber  Research,  Ashland,  OR  (2007).  URL
          http://www.ingber.com/markets07_rops.pdf.

     [31] L.  Ingber,  "Real  Options  for   Project   Schedules   (ROPS),"
     ...
     [32] L.  Ingber,  "Trading in Risk Dimensions (TRD)," Report 2005:TRD,
          Lester    Ingber    Research,    Ashland,    OR    (2005).    URL
          http://www.ingber.com/markets05_trd.pdf.

     [33] L.  Ingber,  "Trading  in  Risk  Dimensions"  in  [4mThe[24m [4mHandbook[24m [4mof[0m
     ...
     [34] L.  Ingber,  "Ideas  by  Statistical  Mechanics  (ISM),"   Report
          2006:ISM,   Lester  Ingber  Research,  Ashland,  OR  (2006).  URL
          http://www.ingber.com/smni06_ism.pdf.

     [35] L. Ingber, "Ideas by Statistical Mechanics (ISM),"  [4mJ[24m  [4mIntegrated[0m
     ...
     [36] L. Ingber, "AI and  Ideas  by  Statistical  Mechanics  (ISM)"  in
     ...
     [37] L.  Ingber,  "Adaptive  Simulated Annealing" in [4mStochastic[24m [4mglobal[0m
     ...
     9.1.50.             ADAPTIVE_OPTIONS=FALSE . . . . . . . . . . . .  28
     9.1.51.             ASA_QUEUE=FALSE  . . . . . . . . . . . . . . .  29
     9.1.52.             ASA_RESOLUTION=FALSE . . . . . . . . . . . . .  30
     9.1.53.             ASA_FUZZY=FALSE  . . . . . . . . . . . . . . .  30
     9.1.54.             FITLOC=FALSE . . . . . . . . . . . . . . . . .  30
     9.1.55.             FITLOC_ROUND=TRUE  . . . . . . . . . . . . . .  31
     9.1.56.             FITLOC_PRINT=TRUE  . . . . . . . . . . . . . .  31
     9.1.57.             MULTI_MIN=FALSE  . . . . . . . . . . . . . . .  31
     9.1.58.             ASA_PARALLEL=FALSE . . . . . . . . . . . . . .  32
     9.1.59.             FDLIBM_POW=FALSE . . . . . . . . . . . . . . .  33
     9.1.60.             FDLIBM_LOG=FALSE . . . . . . . . . . . . . . .  33
     9.1.61.             FDLIBM_EXP=FALSE . . . . . . . . . . . . . . .  33
     9.2.           Printing DEFINE_OPTIONS . . . . . . . . . . . . . .  33
     9.2.1.              USER_OUT=\"asa_usr_out\" . . . . . . . . . . .  33
     9.2.2.              USER_ASA_USR_OUT=FALSE . . . . . . . . . . . .  33
     9.2.3.              INCL_STDOUT=TRUE . . . . . . . . . . . . . . .  33
     9.2.4.              ASA_PRINT=TRUE . . . . . . . . . . . . . . . .  34
     9.2.5.              ASA_OUT=\"asa_out\"  . . . . . . . . . . . . .  34
     9.2.6.              USER_ASA_OUT=FALSE . . . . . . . . . . . . . .  34
     9.2.7.              ASA_PRINT_INTERMED=TRUE  . . . . . . . . . . .  34
     ...
     9.3.7.              OPTIONS->Number_Cost_Samples[5]  . . . . . . .  41
     ...
     9.3.12.             OPTIONS->Include_Integer_Parameters[FALSE]
      . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .  43
     9.3.13.             OPTIONS->User_Initial_Parameters[FALSE]  . . .  43
     9.3.14.             OPTIONS->Sequential_Parameters[-1] . . . . . .  43
     ...
     lus[10000] . . . . . . . . . . . . . . . . . . . . . . . . . . . .  44
     9.3.20.             OPTIONS->Reanneal_Cost[1]  . . . . . . . . . .  44
     9.3.21.             OPTIONS->Reanneal_Parameters[TRUE] . . . . . .  45
     9.3.22.             OPTIONS->Delta_X[0.001]  . . . . . . . . . . .  45
     9.3.23.             OPTIONS->User_Delta_Parameter  . . . . . . . .  46
     9.3.24.             OPTIONS->User_Tangents[FALSE]  . . . . . . . .  46
     9.3.25.             OPTIONS->Curvature_0[FALSE]  . . . . . . . . .  46
     9.3.26.             OPTIONS->User_Quench_Param_Scale . . . . . . .  47
     9.3.27.             OPTIONS->User_Quench_Cost_Scale  . . . . . . .  47
     ...
     9.3.33.             OPTIONS->Best_Parameters . . . . . . . . . . .  49
     9.3.34.             OPTIONS->Last_Cost . . . . . . . . . . . . . .  49
     ...
     9.3.39.             OPTIONS->Asa_Data_Int  . . . . . . . . . . . .  50
     9.3.40.             OPTIONS->Asa_Data_Dim_Ptr  . . . . . . . . . .  50
     9.3.41.             OPTIONS->Asa_Data_Ptr  . . . . . . . . . . . .  51
     9.3.42.             OPTIONS->Asa_Out_File  . . . . . . . . . . . .  51
     9.3.43.             OPTIONS->Asa_Usr_Out_File  . . . . . . . . . .  52
     9.3.44.             OPTIONS->Cost_Schedule . . . . . . . . . . . .  52
     9.3.45.             OPTIONS->Asymp_Exp_Param . . . . . . . . . . .  52
     9.3.46.             OPTIONS->Acceptance_Test . . . . . . . . . . .  52
     9.3.47.             OPTIONS->User_Acceptance_Flag  . . . . . . . .  52
     ...
     9.3.52.             OPTIONS->Prob_Bias . . . . . . . . . . . . . .  53
     9.3.53.             OPTIONS->Random_Seed . . . . . . . . . . . . .  53
     9.3.54.             OPTIONS->Generating_Distrib  . . . . . . . . .  53
